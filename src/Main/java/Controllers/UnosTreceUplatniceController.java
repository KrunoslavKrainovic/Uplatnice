...
public class UnosTreceUplatniceController {
    ...
    @FXML
    public void printanjeTreceUplatnice() throws IOException, URISyntaxException {
        DrawingService upisTreceUplatnice = new DrawingService();
        upisTreceUplatnice.trecaUplatnica(imeIPrezime.getText(),adresa.getText(),gradIPostanskibroj.getText(),iznos.getText(),model.getText(),brojPrimatelja.getText(),opisPlacanja.getText(),valutaIIznos.getText(),racunPrimatelja.getText(),modelIBrojPrimatelja.getText());
