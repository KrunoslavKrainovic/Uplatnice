...
Ovaj program omogućava ispisivanje podataka na već postojeće prazne uplatnice na papiru A4 formata. Podaci koje upisujemo (ime, prezime, adresa, IBAN, model...) možemo pomicati ovisno o postavljenoj X i Y koordinati, koje možemo mijenjati ovisno o tome odgovara li nam pozicija podataka ili ne. IBAN i ime primatelja možemo po potrebi mijenjati i pomicati po uplatnici. Program također ima i "backup" kojim vraća koordinate na početnu poziciju (početne postavke). Svi podaci se ispisuju na papir formata A4 na kojem se u obliku slike nalaze 3 uplatnice. Klikom na tipku "spremi" koja se nalazi na trećoj uplatnici, slika popunjenih uplatnica sprema se na radnu površinu. Nakon ispisivanja, svi podaci će se nalaziti na za to predviđenim mjestima na papiru.
